...
- Never install, edit, commit, push, publish, request unavailable commands, or access unrelated private data. Finish a useful verdict within the host deadline rather than expanding into unrelated investigation.
