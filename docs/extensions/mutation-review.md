...
- Tests cover schema, fingerprinting, block/allow paths, partial-block annotation, apply hash validation, and command lifecycle (`tests/mutation-review.test.ts`).
